        ...
        <div class="wrap">
                    <div class="search">
                        <form action='search_Supplier.php' method='POST'>
                            <input class="search-bar" type="text" name="search" id="search" placeholder="輸入供應商相關資料">
        ...
        <section class="page-section about-heading">
            ...
            <?php
                    ...
                    if($result=mysqli_query($link, $SQL)){
                        ...
                        echo "<thead align='left'><td><b>Name</b></td><td><b>Address</b></td><td><b>Update</b></td></thead>";
                        while($row=mysqli_fetch_assoc($result)){
                            //echo $row["number"];
                            echo "<tbody align='left'>";
                            echo "<tr align='left'>";
                            echo "<td height='50px' align='left'>".$row["name"]."</td>
                            <td align='left'>".$row["address"]."</td>
                            <td class='main'><button style='border-radius: 4px;border: 0px;background-color: white;'><a href='deleteSupplier.php?name=".$row["name"]."'>Delete</a></button>  <button style='border-radius: 4px;border: 0px;background-color: white;'><a href='updateSupplier.php?name=".$row["name"]."'>update</a></button></td>";
                            echo "</tr>";
                            echo "</tbody>";
                        }
                    }
            ...
            <button class="button"><a href="addSupplier.php">add</a></button>
        </section>
    </body>
</html>
