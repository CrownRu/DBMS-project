...
<html lang="en">
    ...
    <body>
                ...
                <div class="wrap">
                    <div class="search">
                        <form action='search_Customer.php' method='POST'>
                            <input class="search-bar" type="text" name="search" id="search" placeholder="輸入顧客相關資料">
        ...
        <section class="page-section about-heading">
            <div class="container">
                ...
                <?php
                    ...
                    if($result=mysqli_query($link, $SQL)){
                        echo "<table calss='main' border='1' width=1000px style='border:5px #FFD1A4 solid;background-color:Bisque;filter:alpha(opacity=95);opacity:0.9; border='2'>";
                        echo "<thead align='left'><td><b>Number</b></td><td><b>Name</b></td><td><b>Phone</b></td><td><b>Update</b></td></thead>";
                        while($row=mysqli_fetch_assoc($result)){
                            //echo $row["number"];
                            echo "<tbody align='left'>";
                            echo "<tr align='left'>";
                            echo "<td height='50px' align='left'>".$row["cid"]."</td>
                            <td align='left'>".$row["cname"]."</td>
                            <td align='left'>".$row["phone"]."</td>
                            <td class='main'><button style='border-radius: 4px;border: 0px;background-color: white;'><a href='deleteCustomer.php?cid=".$row["cid"]."'>Delete</a></button>  <button style='border-radius: 4px;border: 0px;background-color: white;'><a href='updateCustomer.php?cid=".$row["cid"]."'>update</a></button></td>";
                            echo "</tr>";
                            echo "</tbody>";
                        }
                    }
            ...
            <button class='button'><a href="addCustomer.php">add</a></button>
        </section>
