            ...
            <div class="container">
                ...
                <?php
                    ...
                    if($result=mysqli_query($link, $SQL)){
                        ...
                        echo "<thead align='left'><td>ID</td><td>Name</td><td>Phone</td><td>update</td></thead>";
                        while($row=mysqli_fetch_assoc($result)){
                            ...
                            <td class='main'><button><a href='deleteCustomer.php?cid=".$row["cid"]."'>Delete</a></button><button><a href='updateCustomer.php?cid=".$row["cid"]."'>update</a></button></td>";
                            echo "</tr>";
                            echo "</tbody>";
                        }
                    }
