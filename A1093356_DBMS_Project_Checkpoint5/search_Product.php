        ...
        <section class="page-section about-heading">
            <div class="container">
                ...
                <?php
                    ...
                    $SQL="SELECT * FROM Brand WHERE number LIKE '%$search%' OR bname LIKE '%$search%' OR series LIKE '%$search%' ORDER BY bname";
                    if($result=mysqli_query($link,$SQL)){
                        ...
                        while($row=mysqli_fetch_assoc($result)){
                            ...
                            $brand=$row['bname'];
                            $series=$row['series'];
                            $SQL2="SELECT * FROM Warehouse WHERE number='$number' AND (bname LIKE '%$search%' OR size LIKE '%$search%' OR stock = '$search' OR price ='$search')";
                    ...
                    //echo $row["number"];
                        ...
                        //echo "<thead align='left'><td>品牌</td><td>系列</td><td>鞋款</td><td>尺寸</td><td>庫存</td><td>售價</td><td>編輯</td></thead>";
                            ...
                            //echo $row["number"];
                                        ...
                                        <td class='main'><button><a href='deleteAll.php?number=".$row["number"]."'>Delete</a></button><button><a href='sell.php?number=".$row["number"]."'>Sell</a></button></td>";
                                        echo "</tr>";
                                        echo "</tbody>";
                                    }
                                }
