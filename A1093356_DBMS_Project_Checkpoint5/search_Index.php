        ...
        <section class="page-section about-heading">
            <div class="container">
                ...
                <?php
                    ...
                    $SQL="SELECT * FROM income WHERE brand_name LIKE '$search' OR shoes_name LIKE '%$search%' OR number LIKE '%$search%' OR sum='$search' OR total_earning='$search'";
                    ...
                    if($result=mysqli_query($link, $SQL)){
                        ...
                        echo "<thead align='left'><td>品牌</td><td>名稱</td><td>鞋款</td><td>售出數量</td><td>收益</td></thead>";
