                        ...
                        <div class="form-holder">
                            <div class="form-content">
                                <div class="form-items">
                                    ...
                                    <form class="requires-validation" action="addCustomerConfirm.php" method="post" novalidate>

                                        <div class="col-md-12">
                                        <input class="form-control" type="text" name="id" placeholder="ID" required>
                                        <div class="valid-feedback">Cid field is valid!</div>
                                        <div class="invalid-feedback">Cid field cannot be blank!</div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <input class="form-control" type="text" name="phone" placeholder="Customer Phone" required>
