                        ...
                        <div class="form-holder">
                            <div class="form-content">
                                <div class="form-items">
                                    ...
                                    <form class="requires-validation" action="updateCustomerConfirm.php" method="post" novalidate>
                                    <input type="hidden" name="cid" value='<?php echo $cid;?>'></br>
                    
                                        <div class="col-md-12">
                                            <input class="form-control" type="text" name="cname" value='<?php echo $cname;?>'>
                                            <div class="valid-feedback">Customer name field is valid!</div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="valid-feedback">Customer phone field is valid!</div>
                                            <div class="invalid-feedback">Customer phone field cannot be blank!</div>
                                        </div>
