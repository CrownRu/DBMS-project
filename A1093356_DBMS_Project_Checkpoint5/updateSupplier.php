                        ...
                        <div class="form-holder">
                            <div class="form-content">
                                <div class="form-items">
                                    ...
                                    <form class="requires-validation" action="updateSupplierConfirm.php" method="post" novalidate>
                                    <input type="hidden" name="name" value='<?php echo $name;?>'></br>

                                        <div class="col-md-12">
                                        <input class="form-control" type="text" name="name" value='<?php echo $name;?>'>
                                        <div class="valid-feedback">Supplier name field is valid!</div>
                                        <div class="invalid-feedback">Supplier name field cannot be blank!</div>
                                        </div>

                                        <div class="col-md-12">
                                            <input class="form-control" type="text" name="address" value='<?php echo $address;?>'>
                                            <div class="valid-feedback">Supplier address field is valid!</div>
                                            <div class="invalid-feedback">Supplier address field cannot be blank!</div>
                                        </div>
